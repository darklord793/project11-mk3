...
const b = prompt('Enter position number in the Fibonacci line. To calculate in Massif');
    ...
    if (b === 1) {
        alert "Under the number b :" + b + ", in the Fibonacci line is the number :" + fibonacciMassif[1];
    } else if (b === 2) { 
        alert "Under the number b :" + b + ", in the Fibonacci line is the number :" + fibonacciMassif[2];
    } else {
    for (i = 3; i <= b; i++) {
